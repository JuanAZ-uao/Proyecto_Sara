...
export const menuSections = [
  ...
  },
  {
    id: 'puntos',
    label: 'Puntos Toyota',
    subtitle: 'Conoce y canjea tus beneficios',
    emoji: '🎁',
  },
  {
    id: 'accesorios',
    label: 'Accesorios Toyota',
    subtitle: 'Explora productos exclusivos',
    emoji: '🧢',
  },
  {
    id: 'te',
  ...
  {
    id: 'origami',
    label: 'Sube tu origami',
    subtitle: 'Comparte tu grulla y suma puntos',
    emoji: '🕊️',
  },
]
...
export const senbazuruMeaningInfo = {
  ...
  Longevidad:
    'Se asocia con una vida larga y equilibrada, cuidando el bienestar a lo largo del tiempo.',
}
...
export const puntosWays = [
  { action: 'Agendar una cita', points: '+50' },
  { action: 'Subir una grulla de origami', points: '+100' },
  { action: 'Participar en actividades', points: '+70' },
]

export const puntosBenefits = [
  {
    points: 50,
    service: '10% de descuento en taller o mantenimiento',
    accessory: 'Llavero Toyota',
  },
  {
    points: 100,
    service: '30% de descuento en taller o mantenimiento',
    accessory: 'Gorra Toyota',
  },
  {
    points: 150,
    service: '35% de descuento en taller o mantenimiento',
    accessory: 'Sombrilla Toyota',
  },
  {
    points: 200,
    service: '40% de descuento en taller o mantenimiento',
    accessory: 'Termo Toyota',
  },
]
...
export const playlistUrl =
  'https://open.spotify.com/playlist/2R7jUkXdi7heCdBGSttQDD?si=-2OxPS6QQBqveGawsfvn1A&pi=J2i4mTeWRKeJU'

export const mediaImages = [
  '/images/doc/image1.jpeg',
  '/images/doc/image2.png',
  '/images/doc/image3.png',
  '/images/doc/image4.jpeg',
  '/images/doc/image5.jpeg',
  '/images/doc/image6.png',
  '/images/doc/image7.png',
  '/images/doc/image8.png',
  '/images/doc/image9.png',
  '/images/doc/image10.jpeg',
]

export const imageBySection = {
  homeBg: '/images/doc/image1.jpeg',
  homeLogo: '/images/doc/image2.png',
  historyLogo: '/images/doc/image2.png',
  historyFrame: '/images/doc/image4.jpeg',
  historyPhoto: '/images/doc/image5.jpeg',
  accessories: [
    { name: 'Termos Toyota', image: '/images/doc/image6.png' },
    { name: 'Gorras Toyota', image: '/images/doc/image7.png' },
    { name: 'Llaveros', image: '/images/doc/image8.png' },
    { name: 'Sombrillas', image: '/images/doc/image9.png' },
  ],
  tea: '/images/doc/image10.jpeg',
}
